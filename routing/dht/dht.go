...
func (dht IpfsDHT) findPeerSingle(p *peer.Peer, id peer.ID, timeout time.Duration, level int) (*PDPBDHTMessage, error) {
	pmes := DHTMessage{
		Type:   PBDHTMessage,
		Key:    string(id),
		Id:     GenerateMessageID(),
